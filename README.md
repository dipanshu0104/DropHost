...
Your self hosted file uploading server.

![alt text](public/images/Capture.PNG)

# What is DropHost? 

The DropHost server is basically used to create a self file hosted file uploading server. Which is use to upload a file on a server computer and also manage these files with the help of a impressive web UI.
